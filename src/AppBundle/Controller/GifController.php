...
class GifController extends Controller
{
     ...
     */
    public function showAction(Gif $gif)
    {
    ...
    /**
     * @Route("/gif/{id}/details", name="gif_show_details")
     * @ParamConverter("gif", class="AppBundle:Gif")
     */
    public function showDetailsAction(Gif $gif)
    {
        $appRoot = $this->get('kernel')->getRootDir() . '/..';
        ...
        return $this->render('default/gif_show.html.twig',[
            'gif' => $gif,
        ]);
    }

    /**
     * @Route("/gif/{id}/{noop}.gif", name="gif_show_original")
     * @ParamConverter("gif", class="AppBundle:Gif")
     */
    public function showOriginalAction(Gif $gif)
    {
        $appRoot = $this->get('kernel')->getRootDir() . '/..';
